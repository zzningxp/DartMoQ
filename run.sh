...
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m0.5 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m0.625 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m0.75 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m0.875 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.125 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.25 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.375 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.5 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.625 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.75 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.875 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.125 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.25 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.375 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.5 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.625 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.75 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.875 --use-hybrid-moe --quantmode gptq
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3 --use-hybrid-moe --quantmode gptq

# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m0.5 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m0.625 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m0.75 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m0.875 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.125 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.25 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.375 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.5 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.625 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.75 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m1.875 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.125 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.25 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.375 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.5 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.625 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.75 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m2.875 --use-hybrid-moe --quantmode turboquant
# python run_dartmoq.py $modelname wikitext2 --slices 8 --nsamples 64 --rank-mode turboquant_activation --quant-scheme global-bpw-a8s8m3 --use-hybrid-moe --quantmode turboquant
