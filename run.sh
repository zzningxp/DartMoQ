...
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.5 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.625 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.75 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m1.875 --use-hybrid-moe
...
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m2.875 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.125 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.25 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.375 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.5 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.625 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.75 --use-hybrid-moe
python run_dartmoq.py ~/models/deepseek-moe-16b-base/ wikitext2 --slices 8 --nsamples 64 --rank-mode quant_outlier --quant-scheme global-bpw-a8s8m3.875 --use-hybrid-moe
